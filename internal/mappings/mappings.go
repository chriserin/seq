...
var mappings = registry{
	...
	OperationKey{focus: operation.FocusAny, key: k("ctrl+b")}:                                                    BeatInputSwitch,
	OperationKey{focus: operation.FocusAny, key: k("ctrl+k")}:                                                    CyclesInputSwitch,
	OperationKey{focus: operation.FocusAny, key: k("ctrl+c")}:                                                    ChangePart,
	OperationKey{focus: operation.FocusAny, key: k("ctrl+e")}:                                                    AccentInputSwitch,
	OperationKey{focus: operation.FocusAny, key: k("ctrl+a")}:                                                    ToggleArrangementView,
	OperationKey{focus: operation.FocusAny, key: k("ctrl+l")}:                                                    NewLine,
	OperationKey{focus: operation.FocusAny, key: k("ctrl+n")}:                                                    New,
	OperationKey{focus: operation.FocusAny, key: k("ctrl+o")}:                                                    OverlayInputSwitch,
	OperationKey{focus: operation.FocusAny, key: k("ctrl+p")}:                                                    NewSectionBefore,
	OperationKey{focus: operation.FocusAny, key: k("ctrl+d")}:                                                    SetupInputSwitch,
	...
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("t", "M")}:                     MajorTriad,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("t", "m")}:                     MinorTriad,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("t", "d")}:                     DiminishedTriad,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("t", "a")}:                     AugmentedTriad,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("7", "m")}:                     MinorSeventh,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("7", "M")}:                     MajorSeventh,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("5", "a")}:                     AugFifth,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("5", "d")}:                     DimFifth,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("5", "p")}:                     PerfectFifth,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("2", "m")}:                     MinorSecond,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("2", "M")}:                     MajorSecond,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("3", "m")}:                     MinorThird,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("3", "M")}:                     MajorThird,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("4", "p")}:                     PerfectFourth,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("6", "M")}:                     MajorSixth,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("8", "p")}:                     Octave,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("9", "m")}:                     MinorNinth,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("9", "M")}:                     MajorNinth,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("[", "i")}:                     DecreaseInversions,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("]", "i")}:                     IncreaseInversions,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("1", "o")}:                     OmitRoot,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("2", "o")}:                     OmitSecond,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("3", "o")}:                     OmitThird,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("4", "o")}:                     OmitFourth,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("5", "o")}:                     OmitFifth,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("6", "o")}:                     OmitSixth,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("7", "o")}:                     OmitSeventh,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("8", "o")}:                     OmitOctave,
	OperationKey{focus: operation.FocusGrid, mode: operation.SeqModeChord, key: k("9", "o")}:                     OmitNinth,
