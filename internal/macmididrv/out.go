...
// Send writes a MIDI sysex message to the output port
...
// Underlying returns the underlying macmidi.MIDIOut. Use it with type casting:
//
//	rtOut := o.Underlying().(macmidi.MIDIOut)
...
func (o *out) Open() (err error) {
	...
	//	o.Lock()
	//defer o.Unlock()
	o.midiOut, err = macmidi.NewMIDIOutDefault()
	if err != nil {
		o.midiOut = nil
