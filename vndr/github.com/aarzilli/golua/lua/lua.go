...
#cgo lua54,lluadash LDFLAGS: -llua-5.4
...
#cgo darwin,lua54,!llua,!luaa,!luajit,!lluadash5.1,!lluadash pkg-config: lua5.4
...
func (L *State) NewUserdata(size uintptr) unsafe.Pointer {
	return unsafe.Pointer(C.lua_newuserdatauv(L.s, C.size_t(size), 1))
}
